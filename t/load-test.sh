...
PERL5LIB=../lib time perl $CARP ../script/load-chado.pl -d -t $* \
  ...
  --obsolete-term-map ~/pombe/go-doc/obsoletes-exact ../load-pombase-chado.yaml localhost `cat /tmp/new_test_db` kmr44 kmr44 chromosome1.contig.embl 2>&1 | cut -c1-300
