...
then
    ...
    nice -19 docker save $IMAGE_NAME | nice -19 gzip -4v | ssh pombase-admin@149.155.131.177 sudo docker load &&
      ssh pombase-admin@149.155.131.177 "gzip -d | sudo docker service update --image $IMAGE_NAME main-1"
