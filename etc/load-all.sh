...
(cd $POMBE_EMBL
 $POMCUR/bin/pombase-gocam-tool overlapping-nodes supporting_files/noctua-go-cam-models/*.json > supporting_files/nightly_load_results/overlapping_nodes.tsv
