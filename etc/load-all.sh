...
$POMCUR/bin/pombase-chado-json -c $SOURCES/pombe-embl/website/pombase_v2_config.json -p "postgres://kmr44:kmr44@localhost/$DB" -d $CURRENT_BUILD_DIR/web-json  -i /var/pomcur/sources/interpro/pombe_interpro_results.json 2>&1 | tee $LOG_DIR/$log_file.web-json-write
